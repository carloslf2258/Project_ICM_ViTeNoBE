...
import com.example.vitenobe.Matches.MatchesAdapter
import com.example.vitenobe.Matches.MatchesObject
...
class MatchesActivity : AppCompatActivity() {
    ...
    private val userMatchId: Unit
        private get() {
            val matchDb = FirebaseDatabase.getInstance().reference.child("Users").child(cusrrentUserID.toString()).child("connections").child("matches")
